...
metadata {
    ...
    tiles(scale: 2) {
		...
		tileAttribute ("device.button", key: "PRIMARY_CONTROL") {
			attributeState("pushed", label:'', icon:"https://raw.githubusercontent.com/castlecole/Xiaomi/master/ButtonOn.png", backgroundColor:"#359148")
			attributeState("released", label:'', icon:"https://raw.githubusercontent.com/castlecole/Xiaomi/master/ButtonOff.png", backgroundColor:"#00a0dc")
             	}
		...
		tileAttribute ("device.button", key: "PRIMARY_CONTROL") {
                	attributeState("pushed", label:'${name}', icon:"https://raw.githubusercontent.com/castlecole/Xiaomi/master/ButtonOn.png", backgroundColor:"#359148")
                	attributeState("released", label:'${name}', icon:"https://raw.githubusercontent.com/castlecole/Xiaomi/master/ButtonOff.png", backgroundColor:"#00a0dc")
             	}
            	tileAttribute("device.lastCheckin", key: "SECONDARY_CONTROL") {
                	attributeState("default", label:'Last Update: ${currentValue}',icon: "st.Health & Wellness.health9")
            }
