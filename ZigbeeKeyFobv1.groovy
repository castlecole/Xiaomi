...
metadata {
	definition (name: "Key Fob - ZigBee", namespace: "castlecole", author: "Sean Cole", ocfDeviceType: "oic.d.switch", runLocally: true, minHubCoreVersion: '000.019.00012', executeCommandsLocally: true, genericHandler: "Zigbee") {
